...
const SKIP = new Set(["Siachen Glacier", "Indian Ocean Territories"]);
...
const geoPath = path.join(root, "public/geo/asia-countries.json");
const tsPath = path.join(root, "src/lib/asiaCountryIso.ts");
...
body += "export const ASIA_COUNTRY_ISO_A3_TO_NAME: Record<string, string> = {\n";
for (const k of keys) {
