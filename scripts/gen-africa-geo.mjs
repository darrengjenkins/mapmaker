...
const picks = j.features.filter((f) => f.properties.CONTINENT === "Africa");
...
const geoPath = path.join(root, "public/geo/africa-countries.json");
const tsPath = path.join(root, "src/lib/africaCountryIso.ts");
...
body += "export const AFRICA_COUNTRY_ISO_A3_TO_NAME: Record<string, string> = {\n";
for (const k of keys) {
